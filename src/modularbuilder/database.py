...
class Modular_Builder_Database:
    ...
    def modify_object(self, name: str) -> None:
        pass
    
    def duplicate_object(self, old_name : str, new_name : str) -> None:
        pass
    ...
    def modify_model(self, name: str) -> None:
        pass
    
    def duplicate_model(self, name: str) -> None:
        pass
