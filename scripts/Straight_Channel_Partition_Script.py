...
Initial_X_Coord, N_Partitions, Channel_Width, Grid_Spacing = getInputs(fields=Fields_Parameters,
...
for i in range(N_Partitions):
    ...
    Part_To_Partition.DatumPointByCoordinate((Initial_X_Coord + i*Grid_Spacing, 0, 0))
    ...
    Part_To_Partition.DatumPointByCoordinate((Initial_X_Coord + i*Grid_Spacing + Channel_Width, 0, 0))
    Datum_Point = max(Part_To_Partition.datums.keys())
    Part_To_Partition.PartitionCellByPlanePointNormal(normal = x_axis, cells=Set_To_Partition.cells, point=Part_To_Partition.datums[Datum_Point])