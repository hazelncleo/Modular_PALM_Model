...
Initial_X_Coord, Initial_Y_Coord, N_Partitions, Grid_Spacing = getInputs(fields=Fields_Parameters,
...
for i in range(N_Partitions):
    ...
    # Partition in the x direction (along the y axis)
    Part_To_Partition.DatumPointByCoordinate((Initial_X_Coord, Initial_Y_Coord + i*Grid_Spacing, 0))
    ...
    # Partition in the y direction (along the x axis)
    Part_To_Partition.DatumPointByCoordinate((Initial_X_Coord + i*Grid_Spacing, Initial_Y_Coord, 0))
    Datum_Point = max(Part_To_Partition.datums.keys())
