...
class Analysis_Object:
    ...
    description : str
        A short description of what the analysis is
    ...
    requirements : dict
        A dictionary containing the requirements of the analysis.
    ...
    def new_object_name(self):
        ...
        print('Please enter a new ' + blue_text('name') + ' for the Analysis Object to be created: ')
        print('Note: ')
    ...
    def define_parameters(self):
        ...
        print('-'*60)
        print(green_text('Parameters chosen for the analysis are: '))
