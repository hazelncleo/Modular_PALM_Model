...
class Geometry_Object:
    '''
    ---------------------------------------------------
    Contains all the relevant information for a Geometry Object
    ---------------------------------------------------
    Attributes
    ---------------------------------------------------
    ...
    def __init__(self, builder):
        ...
        print('-----------------------------------------------')
        print('Create Geometry Object operation started.')
        print('-----------------------------------------------')
        ...
        self.fpath = os.path.join(self.builder.fpaths['geometry'],self.name)
    ...
    def new_object_name(self):
        '''
        ---------------------------------------------------
        Gets a new Geometry Object name, ensures that no object already exists of that type
        ---------------------------------------------------
        '''
        # Get current names
        current_names = [name for name in self.builder.data['geometry'].keys()]
        ...
        while True:
            print('---------------------------------------------------')
            print('Please enter a new name for the Geometery Object to be created: ')
            print('Note: ')
            print('- It must only use letters, numbers, underscores and hyphens.')
            print('- It must be lowercase.')
            print('- It must be unique.')
            print('---------------------------------------------------')
            print('The Geometry names currently in use are listed below: ')
            print(current_names)
            print('---------------------------------------------------')
    ...
    def new_description(self):
        '''
        ---------------------------------------------------
        Provide a description for the Geometry Object added to the database.
        ---------------------------------------------------
        '''
    ...
    def get_file_path(self):
        ...
        file_path = askdirectory(title = 'Select folder to read Geometry files from: ', initialdir=os.path.abspath(os.getcwd()))
    ...
    def define_parameters(self):
        ...
        while True:
            ...
            if command == 'exit':
                ...
                print('Parameters chosen for the Geometry are: ')
