...
def fluent_setup(
        ...
        parameters     = {
            ...
            'noise_frequency'     : {'default_value' : 1.4e5},
            'noise_amplitude'     : {'default_value' : 1e-7}
        }
    ):
    '''
    ----------------------------------------------------------------
    ...
    noise_frequency     = parameters['noise_frequency']['default_value']
    noise_amplitude     = parameters['noise_amplitude']['default_value']
    ...
    print('Noise Amplitude                     = {:.1e} micron'.format(noise_amplitude))
    print('Noise Frequency                     = {:.2e} Hz'.format(noise_frequency))
    print('-'*60)
